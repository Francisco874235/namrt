...
tree.Frequency = 5
tree.Parent = close
    local close1 = Instance.new("Sound")
close1.Parent = entityModel.PrimaryPart
close1.Name = "Close1"
close1.SoundId = "rbxassetid://5348162330"
close1.Volume = 0.7
close1.RollOffMaxDistance = 50
close1.RollOffMinDistance = 5
close1.Looped = true
close1:Play()
local distort = Instance.new("DistortionSoundEffect")
distort.Level = 0.75
distort.Parent = close1
local distort = Instance.new("DistortionSoundEffect")
distort.Level = 0.75
distort.Parent = close1
